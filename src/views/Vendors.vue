<template>
  <div class="main-body " style="padding: 2rem 3rem; ">
    ...
    <div class="d-flex justify-content-between align-items-center mb-5 row">
      ...
      <div class="d-flex gap-3 gap-sm-5 col-9">
        ...
        <button class="vendor-btn ms-auto">
          <div style="display: inline-block;justify-self: center !important;">Locations</div>
        ...
        <button class="vendor-btn">
          <div style="display: inline-block;justify-self: center !important;">Category</div>
          <svg style="width: 0.6rem;height: 1rem;" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              d="M5.77635 2.03715L2.80969 5.00382L5.77635 7.97048C6.07455 8.26868 6.07455 8.75038 5.77635 9.04857C5.47816 9.34677 4.99646 9.34677 4.69826 9.04857L1.18873 5.53904C0.890532 5.24084 0.890532 4.75914 1.18873 4.46095L4.69826 0.951415C4.99646 0.653219 5.47816 0.653219 5.77635 0.951415C6.0669 1.24961 6.07455 1.73896 5.77635 2.03715Z"
              fill="#464A61" />
        ...
        <span style="position: relative  ">
          <input type="search" class="vendor-btn" style="width: 31.5rem !important;height: 5.2rem;"
            placeholder="Search">
    ...
    <!-- tabs -->
    <div class="border-bottom w-100 ps-3 d-flex gap-5 " style="position: relative;">

      <div class="nav-indicator" :style="{ left: slideTo, width: slideWidth }"></div>
      ...
      <button class="tabs-btn" @click="handleSwip" :data-val="3">Suspended</button>
    </div>
...
const handleSwip = (e) => {
  ...
  const el = document.querySelector(`.tabs-btn[data-val="${showSection.value}"]`)
