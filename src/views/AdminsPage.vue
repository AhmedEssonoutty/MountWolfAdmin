<template>
  <div class="main-body" style="padding: 2 rem 3rem">
    ...
    <!-- all admins -->
    <AllAdmins @editAdmin="editAdmin($event)"></AllAdmins>

    <!-- add admin -->
    <AddAdmin @resetAdmin="item = {}" :admin="item"></AddAdmin>
  </div>
</template>
...
import AllAdmins from "@/components/page-component/Admin/AllAdmins.vue";
import AddAdmin from "@/components/page-component/Admin/AddAdmin.vue";
const item = ref({});
const editAdmin = (e) => {
  item.value = e;
